...
function Nav() {
    ...
    return (
        <nav className="nav-container">
            ...
            <Link to="/standings" className="nav-link-container">
                <div className="nav-icon-container">
            ...
            <Link to="/stats" className="nav-link-container">
                <div className="nav-icon-container">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link to="/roster" className="nav-link-container">
                <div className="nav-icon-container">
            ...
            <Link to="/update-profile" className="nav-link-container">
                <div className="nav-icon-container">
